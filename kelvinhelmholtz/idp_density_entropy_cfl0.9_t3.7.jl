...
save_solution = SaveSolutionCallback(output_directory="out/kelvinhelmholtz/idp_density_entropy_t3_7/",
                                     interval=5000,
                                     save_initial_solution=true,
                                     save_final_solution=true,
                                     solution_variables=cons2prim)

save_restart = SaveRestartCallback(output_directory="out/kelvinhelmholtz/idp_density_entropy_t3_7/",
                                   interval=50000,
