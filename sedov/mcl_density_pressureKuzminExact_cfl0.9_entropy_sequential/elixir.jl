...
- https://flash.rochester.edu/site/flashcode/user_support/flash_ug_devel/node184.html#SECTION010114000000000000000
"""
function initial_condition_sedov_blast_wave(x, t, equations::CompressibleEulerEquations2D)
  # Set up polar coordinates
  inicenter = SVector(0.0, 0.0)
  #inicenter = SVector(0.015625,0.015625)
...
#surface_flux = FluxPlusDissipation(flux_central, DissipationLocalLaxFriedrichs(max_abs_speed_Guermond_Popov))
volume_flux  = flux_chandrashekar # flux_central # flux_chandrashekar
...
indicator_sc = IndicatorMCL(equations, basis;
			    ...
			    PressurePositivityLimiter=false, 
